  ...
  return (
    <div className="space-y-6 max-w-2xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-xs text-muted-foreground">Bot: @{botUsername}</div>
              {connectedAt && (
      ...
      <div className="rounded-xl border border-border bg-card p-5 space-y-3">
        <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">💡 Tips</h4>
        <ul className="space-y-1.5 text-xs text-muted-foreground">
          <li>• Untuk grup Telegram, tambahkan bot ke grup dan kirim pesan apa saja, lalu lihat <code className="px-1 bg-maroon-darker rounded font-mono">/getGroupId</code> dari bot.</li>
